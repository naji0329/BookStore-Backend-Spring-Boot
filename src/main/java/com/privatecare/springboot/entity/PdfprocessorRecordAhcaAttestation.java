...
@Entity(name="pdfprocessor_record_ahca_attestation")
@Table(name="pdfprocessor_record_ahca_attestation")
public class PdfprocessorRecordAhcaAttestation implements Serializable {
