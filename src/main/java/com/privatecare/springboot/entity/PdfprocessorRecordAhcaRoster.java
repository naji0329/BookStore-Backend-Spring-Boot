...
@Entity(name="pdfprocessor_record_ahca_roster")
@Table(name="pdfprocessor_record_ahca_roster")
public class PdfprocessorRecordAhcaRoster implements Serializable {
