...
@Entity(name="pdfprocessor_record_auto_insurance")
@Table(name="pdfprocessor_record_auto_insurance")
public class PdfprocessorRecordAutoInsurance implements Serializable {
