...
@Entity(name="pdfprocessor_record_confirmation")
@Table(name="pdfprocessor_record_confirmation")
public class PdfprocessorRecordConfirmation implements Serializable {
