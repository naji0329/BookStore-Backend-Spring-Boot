...
@Entity(name="pdfprocessor_record_contractor_agree")
@Table(name="pdfprocessor_record_contractor_agree")
public class PdfprocessorRecordContractorAgree implements Serializable {
