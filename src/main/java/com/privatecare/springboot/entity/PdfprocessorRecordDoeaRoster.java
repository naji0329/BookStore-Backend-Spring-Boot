...
@Entity(name="pdfprocessor_record_doea_roster")
@Table(name="pdfprocessor_record_doea_roster")
public class PdfprocessorRecordDoeaRoster implements Serializable {
