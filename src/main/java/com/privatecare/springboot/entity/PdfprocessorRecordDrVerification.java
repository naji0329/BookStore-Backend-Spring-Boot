...
@Entity(name="pdfprocessor_record_dr_verification")
@Table(name="pdfprocessor_record_dr_verification")
public class PdfprocessorRecordDrVerification implements Serializable {
