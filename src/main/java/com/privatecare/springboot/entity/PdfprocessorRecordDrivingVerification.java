...
@Entity(name="pdfprocessor_record_driving_verification")
@Table(name="pdfprocessor_record_driving_verification")
public class PdfprocessorRecordDrivingVerification implements Serializable {
