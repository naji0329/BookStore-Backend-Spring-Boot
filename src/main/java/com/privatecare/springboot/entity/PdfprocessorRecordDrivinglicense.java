...
@Entity(name="pdfprocessor_record_drivinglicense")
@Table(name="pdfprocessor_record_drivinglicense")
public class PdfprocessorRecordDrivinglicense implements Serializable {
