...
@Entity(name="pdfprocessor_record_employment_agree")
@Table(name="pdfprocessor_record_employment_agree")
public class PdfprocessorRecordEmploymentAgree implements Serializable {
