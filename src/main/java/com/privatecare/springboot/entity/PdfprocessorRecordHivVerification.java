...
@Entity(name="pdfprocessor_record_hiv_verification")
@Table(name="pdfprocessor_record_hiv_verification")
public class PdfprocessorRecordHivVerification implements Serializable {
