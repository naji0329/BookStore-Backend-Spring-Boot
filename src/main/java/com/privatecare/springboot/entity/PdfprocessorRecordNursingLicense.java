...
@Entity(name="pdfprocessor_record_nursing_license")
@Table(name="pdfprocessor_record_nursing_license")
public class PdfprocessorRecordNursingLicense implements Serializable {
