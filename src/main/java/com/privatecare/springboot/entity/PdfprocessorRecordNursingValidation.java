...
@Entity(name="pdfprocessor_record_nursing_validation")
@Table(name="pdfprocessor_record_nursing_validation")
public class PdfprocessorRecordNursingValidation implements Serializable {
