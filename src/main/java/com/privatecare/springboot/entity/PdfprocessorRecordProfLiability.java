...
@Entity(name="pdfprocessor_record_prof_liability")
@Table(name="pdfprocessor_record_prof_liability")
public class PdfprocessorRecordProfLiability implements Serializable {
