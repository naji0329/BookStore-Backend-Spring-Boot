...
@Entity(name="pdfprocessor_record_references2")
@Table(name="pdfprocessor_record_references2")
public class PdfprocessorRecordReferences2 implements Serializable {
