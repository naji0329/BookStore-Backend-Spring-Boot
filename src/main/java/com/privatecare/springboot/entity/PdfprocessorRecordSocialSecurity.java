...
@Entity(name="pdfprocessor_record_social_security")
@Table(name="pdfprocessor_record_social_security")
public class PdfprocessorRecordSocialSecurity implements Serializable {
