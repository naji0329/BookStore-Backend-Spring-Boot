...
@Entity(name="pdfprocessor_record_vaccination")
@Table(name="pdfprocessor_record_vaccination")
public class PdfprocessorRecordVaccination implements Serializable {
